  ...
  return (
    <header className="bg-darkBlue font-body sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap px-4 py-2 items-center">
        ...
        <nav className={isActive ? 'flex flex-col items-center absolute top-full right-0 p-4 bg-darkBlue w-full h-screen text-center' : 'ml-auto hidden lg:flex lg:gap-4 flex-wrap items-center text-base justify-center'}>
